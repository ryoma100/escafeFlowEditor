...
public class ResizeNodeLeftStrategy extends AbstractDragStrategy
{
	 ...
	 * @category initialize
	 */	
	public function ResizeNodeLeftStrategy(aGraph: BuriGraphEditor, aNode: Node): void {
		super(aGraph);
		_node = aNode;
	}
	...
	{
		var dx: int = _oldPoint.x - point.x;
